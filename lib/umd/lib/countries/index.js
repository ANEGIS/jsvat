(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./andorra", "./austria", "./belgium", "./brazil", "./bulgaria", "./canada", "./croatiat", "./cyprus", "./czechRepublic", "./denmark", "./estonia", "./europe", "./finland", "./france", "./germany", "./greece", "./hungary", "./ireland", "./italy", "./latvia", "./lithuania", "./luxembourg", "./malta", "./netherlands", "./norway", "./poland", "./portugal", "./romania", "./russia", "./serbia", "./slovakiaRepublic", "./slovenia", "./spain", "./sweden", "./switzerland", "./unitedEmirates", "./unitedKingdom", "./unitedStates"], factory);
    }
    ...
    var unitedEmirates_1 = require("./unitedEmirates");
    ...
    var unitedStates_1 = require("./unitedStates");
